                    ...
                    <div className="hidden md:block">
                        <nav className="ml-10 flex items-center space-x-2">
                            ...
                            <button
                                ...
                                className="p-2 rounded-full text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-sky-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
                ...
                <div className="md:hidden absolute top-16 inset-x-0 bg-white dark:bg-slate-950 h-screen z-50">
                    <div className="px-2 pt-2 pb-3 space-y-2 sm:px-3 flex flex-col items-center justify-center h-full -mt-16">
                        ...
                        <button
                            ...
                            className="text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-sky-400 px-3 py-2 rounded-md text-base font-medium transition-all duration-200 hover:scale-105 flex items-center space-x-2"
                        >
                            {theme === 'light' ? <MoonIcon className="h-5 w-5" /> : <SunIcon className="h-5 w-5" />}
